...
app.controller('WrapperCtrl', ['$scope', '$ionicSideMenuDelegate','$meteorCollection', '$ionicModal',
	function($scope, $ionicSideMenuDelegate, $meteorCollection, $ionicModal){
		...
		// upload modal
		$ionicModal.fromTemplateUrl('client/pages/core/upload.ng.html', {
			scope: $scope,
...
app.controller('ExploreCtrl', ['$scope', '$meteorCollection', '$ionicModal', '$rootScope', '$ionicSideMenuDelegate', '$ionicPopup', '$cordovaDatePicker',
	function ($scope, $meteorCollection, $ionicModal, $rootScope, $ionicSideMenuDelegate, $ionicPopup, $cordovaDatePicker) {
		$scope.guides = [
